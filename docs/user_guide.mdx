...
## Language
The oracle index will automatically display translated content if available. Both page contents and the navigation bar will be translated. The search does not support searching
for translated content yet, but will open results in the translated version if available.