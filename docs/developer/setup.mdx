...
navigation bar.
3. Copy the entire wiki to your mods resources folder. The correct path is: "resources/assets/oracle_index/books/your-mod-id/". To automatically do this, see [auto gradle sync](../developer/gradle_task)
